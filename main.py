...
if start:
    ...
    while running:
        ...
        if flag:
            ...
            text = font.render("Новый уровень! Выбери одно из трех.", True, pygame.Color('black'))
            screen.blit(text, (100, 100))
            text = font.render("(Что бы выбрать, нажми кнопку 1, 2 или 3 соответственно)", True, pygame.Color('black'))
            screen.blit(text, (30, 120))
            for i in range(3):
                text = font.render(levels_dict[random_ups[i]][0], True,
                                   pygame.Color('black'))
                screen.blit(text, (60, 150+30*i))
            if pygame.key.get_pressed()[pygame.K_1]:
                ...
                random_ups = []
                player_group.sprites()[0].leveled_up = False
            print(player_group.sprites()[0].speed, player_group.sprites()[0].gun.reload_delay_par,player_group.sprites()[0].gun.delay_par)

            # когда выбрал чистить рандомап
